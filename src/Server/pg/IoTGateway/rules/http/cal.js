...
app.post("/cal/Cfoot/traffic",  function(req, res) {
...
// 接收格式：x-www-form-urlencoded
app.post("/cal/Cfoot/other", function(req, res) {
...
// 接收格式：x-www-form-urlencoded
app.post("/cal/CBAM/emissions", function(req, res) {
...
// 接收格式：x-www-form-urlencoded
app.post("/cal/CBAM/CC_simple",  function(req, res) {
